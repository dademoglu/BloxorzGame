...
def display():
    ...
    for tiles in playground:
        if cube.AABB.check_collision(tiles.AABB):
            cube.collisionCount += 1
            tiles.obj_data.meshes[0].material.Kd = glm.vec3(0.2, 0.2, 0.2)
        else:
            tiles.obj_data.meshes[0].material.Kd = glm.vec3(0.9, 0.9, 0.9)
